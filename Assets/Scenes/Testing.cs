...
namespace Oculus.Interaction.Samples
{
    public class Testing : MonoBehaviour
    {
        ...
        [SerializeField]
        private string _displayText = "wave";
        ...
        protected virtual void Start()
        {
            ...
            for (int i = 0; i < _poses.Length; i++)
            {
                ...
                _poseActiveVisuals[i].GetComponentInChildren<TextMeshPro>().text = _displayText;                _poseActiveVisuals[i].GetComponentInChildren<ParticleSystemRenderer>().material = _onSelectIcons[i];
